  ...
  return (
    <div className="max-w-sm mx-auto">
      ...
      <div className="flex space-x-2 overflow-auto px-4 pb-2 ">
        <Button onClick={()=>{
          router.push("./rec");
        }} className="bg-white text-black text-xs">Recommended</Button>
      ...
      <h1 className="">Recommended for you</h1>
        ...
        <div className="grid grid-cols-2 gap-4 ">
          <Card className="bg-[#E7F6FF] rounded-lg p-4 ">
            ...
            <Button  onClick={() => {
                window.open(
                  "https://open.spotify.com/playlist/37i9dQZF1DX4sWSpwq3LiO?si=KyrbRzHmSVOcLNExhbaNcw&pi=a-fFrfrNKlTEe4",
                  "_blank"
                );
              }} className="bg-white text-black rounded-full text-xs flex items-center mt-2">
              Play Now
              <Image
                alt="play"
                className="ml-1"
          ...
          <Card className="bg-[#FFE8EC] rounded-lg p-4">
            ...
            <Button onClick={() => {
                window.open(
                  "https://open.spotify.com/playlist/6HhLjsFt1JywDYIbnN7ghQ?si=nu9H-Kq7Q3OuU2tb5aGEqg&pi=a-aO7b3uoISz27",
                  "_blank"
                );
              }} className="bg-white text-black text-xs rounded-full flex items-center mt-2">
              Play Now
              <Image
                alt="play"
                className="ml-1"
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="bg-[#FFFACA] rounded-lg p-4">
            ...
            <Button onClick={() => {
                window.open(
                  "https://open.spotify.com/playlist/4BrqsI4l28UmsY0WtahSoR?si=Mo29dZcKSfyeAZfdU0XSlA&pi=a-wHBv7D0JRhyy",
                  "_blank"
                );
              }} className="bg-white text-black rounded-full text-xs flex items-center mt-2">
              Play Now
          ...
          <Card className="bg-[#EEE5FF] rounded-lg p-4">
            ...
            <Button onClick={() => {
                window.open(
                  "https://open.spotify.com/playlist/0NJ6YL317foECWaHFcMqLq?si=wsiVV1FcTB6xuNC3556opA&pi=a-Vv_k-HElQ-uT",
                  "_blank"
                );
              }} className="bg-white rounded-full text-black text-xs flex items-center mt-2">
              Play Now
              <Image
                alt="play"
                className="ml-1"
