  ...
  return (
    <div className="max-w-sm mx-auto">
      ...
      <div className="flex space-x-2 overflow-auto px-4 pb-2 ">
        ...
        <Button className="bg-white text-black text-xs">Soulful Instrumental</Button>
        <Button className=" bg-white text-black text-xs">Healing Frequency</Button>
      </div>
      <div className="grid grid-cols-1 gap-4 px-4">
        <Card className="bg-[#FFD3B6] rounded-lg p-4">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-semibold">Flute Meditation</h2>
            <Button className="bg-white rounded-full text-black text-xs flex items-center" onClick={()=>{window.open("https://open.spotify.com/playlist/37i9dQZF1DXcj8Mdu8qUVH?si=70-XbvtzQO6smwdWCJZrHg&pi=a-Mrb3I50WQnK2","_blank")}}>
              Continue Playing
              <img alt="play" className="ml-1" src="/icons/play.png"/>
            </Button>
          </div>
          <img
